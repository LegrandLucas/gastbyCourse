...
if (process.env.gatsby_executing_command === `develop` && !process.env.GATSBY_EXPERIMENTAL_DEV_SSR && !(0, _gatsbyCoreUtils.isCI)() && (0, _sampleSiteForExperiment.default)(`DEV_SSR`, 1)) {
